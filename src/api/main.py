"""Integration Test Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Integration and E2E test automation agent that generates contract tests, API integration tests, database integration tests, and end-to-end workflow tests with automatic test environment provisioning and teardown.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
