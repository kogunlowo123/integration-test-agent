"""Integration Test Agent - Main Agent Implementation."""
...
class IntegrationTestAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.contract_testing_enabled = True
        self.api_integration_tests_enabled = True
        self.db_integration_tests_enabled = True
        self.e2e_tests_enabled = True
        self.test_env_provisioning_enabled = True
        self._tool_dispatch = {
            "generate_contract_tests": self.tools.generate_contract_tests,
            "generate_api_integration_tests": self.tools.generate_api_integration_tests,
            "generate_db_tests": self.tools.generate_db_tests,
            "generate_e2e_tests": self.tools.generate_e2e_tests,
            "provision_test_environment": self.tools.provision_test_environment,
            "generate_test_fixtures": self.tools.generate_test_fixtures,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['contract_testing', 'api_integration_tests', 'db_integration_tests', 'e2e_tests', 'test_env_provisioning'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "generate_contract_tests": ['generate', 'contract', 'tests'],
            "generate_api_integration_tests": ['generate', 'api', 'integration', 'tests'],
            "generate_db_tests": ['generate', 'db', 'tests'],
            "generate_e2e_tests": ['generate', 'e2e', 'tests'],
            "provision_test_environment": ['provision', 'test', 'environment'],
